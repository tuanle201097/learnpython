...
with open("D:/videos_store/review/subtitles_vn.txt", "w",encoding="utf-8") as f:
...
with open('D:/videos_store/review/subtitles_vn.txt', 'r', encoding='utf-8') as source_file:
    with open('D:/videos_store/review/subtitles.txt', 'w', encoding='utf-8') as dest_file:
